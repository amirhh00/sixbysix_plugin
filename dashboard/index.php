...
require_once plugin_dir_path(__FILE__) . 'restaurant-menu.php';
...
require_once plugin_dir_path(__FILE__) . 'clubxq.php';
require_once plugin_dir_path(__FILE__) . 'class-simple-page-ordering.php';
