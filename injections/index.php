...
function add_button_to_footer_on_homepage()
{
  ...
  if (is_front_page()) {
    ...
    <dialog id="popup_newsletter" style="color:white;background: transparent;padding: 0px;  min-width: 300px;max-width: 600px;width: 50%;border-color:#b38d51">
      ...
      <button onclick="this.parentElement.close()" class="close" style="padding:10px;cursor:pointer; position: absolute;right: 10px;top: 10px;background: transparent;border: none; color: var(--sm-color-primary, #b38d51);">
  ...
  $sevenRoomsScript = <<<HTML
    <div class="uagb-ifb-button-wrapper wp-block-button floating_booking">
      <a href="#" class="uagb-infobox-cta-link wp-block-button__link" target="_self" rel="noopener noreferrer" onclick="return false;">
